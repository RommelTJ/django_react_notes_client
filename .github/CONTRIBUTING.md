# Contributing to Django React Notes Client

♥ [Django React Notes Client](https://github.com/RommelTJ/django_react_notes_client) and want to get involved?
...
The [issue tracker](https://github.com/RommelTJ/django_react_notes_client/issues) is
